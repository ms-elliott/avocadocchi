...
.hidden { display: none; }
.upload-empty { text-align: center; padding: 2rem; }
.upload-icon-wrap { position: relative; display: inline-block; margin-bottom: 0.8rem; }
.upload-camera { font-size: 3rem; display: block; }
.upload-ring {
  position: absolute;
  border-radius: 50%;
...
.upload-main { font-size: 1rem; font-weight: 800; color: #374151; }
.upload-sub { font-size: 0.78rem; color: #9ca3af; margin-top: 4px; font-weight: 700; }
.preview-inner { position: relative; width: 100%; }
...
.preview-overlay {
  ...
  font-weight: 800; color: transparent; font-size: 1rem;
}
.upload-zone:hover .preview-overlay { background: rgba(0,0,0,0.4); color: #fff; }
